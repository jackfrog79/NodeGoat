...
module.exports = function(grunt) {
    ...
    // Security test task.
    grunt.registerTask("checkSecurityDependenciesInstalled", function() {
        console.log("Checking to see if chromedriver is installed.");
        try {
            require.resolve("chromedriver");
            grunt.task.run("mochaTest:security");
        } catch (e) {
            console.log(e);
            ...
            grunt.task.run("npm-install:chromedriver@^2.21.2", "mochaTest:security");
        }
    });
    grunt.registerTask("testsecurity", ["env:test", "checkSecurityDependenciesInstalled"]);
